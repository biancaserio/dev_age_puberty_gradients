...
path_list_XCPd = os.listdir(datadir+'XCP-D_output_fu2y')
...
for sub in sub_list_XCPd:
    ...
    sub_path_to_func_data = datadir+'XCP-D_output_fu2y/'+sub+'/ses-2YearFollowUpYArm1/func/'

    sub_corr_matrices = []
    sub_runs = []
    
    # if directory of subject contains fu2y data & functional data (-> if the nested directory ".../fu2y/func/" exists)
    if os.path.isdir(sub_path_to_func_data):
        ...
        sub_list_XCPd_missing_data.append(sub)  # I don't think any XCP directories would have missing fu2y/func directory but just in case
...
scipy.io.savemat(datadir+'ABCD_fu2y_fc_matrices_XCP-d_output.mat', mdict)
