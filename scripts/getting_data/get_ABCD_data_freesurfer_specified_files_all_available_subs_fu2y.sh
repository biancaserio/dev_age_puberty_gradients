# Script for downloading ABCD data freesurfer files (only desired files, for all available subjects) FU2Y 
...
# steps to run script: 
# (0. datalad clone ABCD data -> e.g., pt_02667/data/ABCD/ABCD_freesurfer_2y-followup)
...
pptDIR=/data/pt_02667/data/ABCD/ABCD_freesurfer_2y-followup/

# defining the path to all ppt files 
pptFILES="/data/pt_02667/data/ABCD/ABCD_freesurfer_2y-followup/sub*"
