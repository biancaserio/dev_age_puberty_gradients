...
path_list_XCPd = os.listdir(datadir+'XCP-D_output_fu4y')
...
for sub in sub_list_XCPd:
    ...
    sub_path_to_func_data = datadir+'XCP-D_output_fu4y/'+sub+'/ses-4YearFollowUpYArm1/func/'

    sub_corr_matrices = []
    sub_runs = []
    
    # if directory of subject contains fu4y data & functional data (-> if the nested directory ".../fu4y/func/" exists)
    if os.path.isdir(sub_path_to_func_data):
        ...
        sub_list_XCPd_missing_data.append(sub)  # I don't think any XCP directories would have missing fu4y/func directory but just in case
...
scipy.io.savemat(datadir+'ABCD_fu4y_fc_matrices_XCP-d_output.mat', mdict)
