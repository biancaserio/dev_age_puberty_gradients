...
# Date creation: 22.11.2024, Author: Bianca Serio
...
# 5. run script: bash get_ABCD_data_fmriprep_xcp-d_fc_specifiedsubs.sh /data/p_02667/development/scripts/sub_3_timepoints_qc_val_relabelled.txt
