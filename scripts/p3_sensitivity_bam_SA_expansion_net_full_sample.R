...
# SENSITIVITY ANALYSIS - in full sample (outliers NOT removed) 
# (note: sample is full main sample)
...
resdir = '/data/p_02667/development/results/supplementary/SA_expansion_net_full_sample/'  # supplementary directory
resdir_fig = '/data/p_02667/development/results/supplementary/SA_expansion_net_full_sample/figures/'  # supplementary directory
...
### S-A axis expansion metrics (Network-level)

## Baseline 
mat_SA_expansion_metrics_baseline <- readMat(paste(datadir_local, 'SA_expansion_metrics_baseline.mat', sep = ''))
names(mat_SA_expansion_metrics_baseline)  # print contents of matfile

SA_expansion_net_baseline <- mat_SA_expansion_metrics_baseline$SA.expansion.net.baseline  # shape: 1, 4064
SA_expansion_net_baseline <- t(SA_expansion_net_baseline)  #transposing to get the shape: 4064, 1

# sub ID 
sub_ID_baseline <- mat_SA_expansion_metrics_baseline$sub.ID.baseline   # shape: 4064, 1
...
## 2y follow-up
mat_SA_expansion_metrics_fu2y <- readMat(paste(datadir_local, 'SA_expansion_metrics_fu2y.mat', sep = ''))
names(mat_SA_expansion_metrics_fu2y)  # print contents of matfile

SA_expansion_net_fu2y <- mat_SA_expansion_metrics_fu2y$SA.expansion.net.fu2y  # shape: 1, 1296
SA_expansion_net_fu2y <- t(SA_expansion_net_fu2y)  #transposing to get the shape: 1296, 1

# sub ID 
sub_ID_fu2y <- mat_SA_expansion_metrics_fu2y$sub.ID.fu2y   # shape: 1296, 1
...
## 4y follow-up
mat_SA_expansion_metrics_fu4y <- readMat(paste(datadir_local, 'SA_expansion_metrics_fu4y.mat', sep = ''))
names(mat_SA_expansion_metrics_fu4y)  # print contents of matfile

SA_expansion_net_fu4y <- mat_SA_expansion_metrics_fu4y$SA.expansion.net.fu4y  # shape: 1, 963
SA_expansion_net_fu4y <- t(SA_expansion_net_fu4y)  #transposing to get the shape: 963, 1

# sub ID 
sub_ID_fu4y <- mat_SA_expansion_metrics_fu4y$sub.ID.fu4y   # shape: 963, 1
...
list_SA_axis_grad_num_baseline <- mat_SA_axis_NOT_aligned_baseline$list.SA.axis.grad.num.baseline  # shape: 1, 4064
list_SA_axis_grad_num_baseline <- t(list_SA_axis_grad_num_baseline)  #transposing to get the shape: 4064, 1
...
# gradient number corresponding to S-A axis
list_SA_axis_grad_num_fu2y <- mat_SA_axis_NOT_aligned_fu2y$list.SA.axis.grad.num.fu2y  # shape: 1, 1296
list_SA_axis_grad_num_fu2y <- t(list_SA_axis_grad_num_fu2y)  #transposing to get the shape: 1296, 1
...
# gradient number corresponding to S-A axis
list_SA_axis_grad_num_fu4y <- mat_SA_axis_NOT_aligned_fu4y$list.SA.axis.grad.num.fu4y  # shape: 1, 963
list_SA_axis_grad_num_fu4y <- t(list_SA_axis_grad_num_fu4y)  #transposing to get the shape: 963, 1
...
summary_bam_SA_exp_leg1_full_sample = summary(bam_SA_exp_leg1)

# Save summary
capture.output(summary_bam_SA_exp_leg1_full_sample, file = file.path(resdir, "summary_bam_SA_exp_leg1_full_sample.txt"))
...
ggsave(paste(resdir_fig, 'bam_margtraj_leg1_age_on_SAexp_full_sample.svg', sep = ''), plot = plot_margtraj_age, width = 6, height = 5, dpi = 300)
...
ggsave(paste(resdir_fig, 'bam_margtraj_leg1_pds_on_SAexp_full_sample.svg', sep = ''), plot = plot_margtraj_pds, width = 6, height = 5, dpi = 300)
...
summary_bam_SA_exp_leg2_rcoef_full_sample = summary(bam_SA_exp_leg2_rcoef)

# Save summary
capture.output(summary_bam_SA_exp_leg2_rcoef_full_sample, file = file.path(resdir, "summary_bam_SA_exp_leg2_rcoef_full_sample.txt"))
...
ggsave(paste(resdir_fig, 'bam_smes_leg2_SAexp_on_rcoef_full_sample.svg', sep = ''), plot = plot_smes_SAexp, width = 5, height = 5, dpi = 300)
ggsave(paste(resdir_fig, 'bam_smes_leg2_age_on_rcoef_full_sample.svg', sep = ''), plot = plot_smes_age, width = 5, height = 5, dpi = 300)
ggsave(paste(resdir_fig, 'bam_smes_leg2_pds_on_rcoef_full_sample.svg', sep = ''), plot = plot_smes_pds, width = 5, height = 5, dpi = 300)
...
ggsave(paste(resdir_fig, 'bam_margtraj_leg2_SAexp_on_rcoef_full_sample.svg', sep = ''), plot = plot_margtraj_SAexp, width = 6, height = 5, dpi = 300)
...
ggsave(paste(resdir_fig, 'bam_margtraj_leg2_age_on_rcoef_full_sample.svg', sep = ''), plot = plot_margtraj_age, width = 6, height = 5, dpi = 300)
...
ggsave(paste(resdir_fig, 'bam_margtraj_leg2_pds_on_rcoef_full_sample.svg', sep = ''), plot = plot_margtraj_pds, width = 6, height = 5, dpi = 300)
...
summary_bam_SA_exp_leg2_gradflip_full_sample = summary(bam_SA_exp_leg2_gradflip)

# Save summary
capture.output(summary_bam_SA_exp_leg2_gradflip_full_sample, file = file.path(resdir, "summary_bam_SA_exp_leg2_gradflip_full_sample.txt"))
...
ggsave(paste(resdir_fig, 'bam_smes_leg2_SAexp_on_gradflip_full_sample.svg', sep = ''), plot = plot_smes_SAexp, width = 5, height = 5, dpi = 300)
ggsave(paste(resdir_fig, 'bam_smes_leg2_age_on_gradflip_full_sample.svg', sep = ''), plot = plot_smes_age, width = 5, height = 5, dpi = 300)
ggsave(paste(resdir_fig, 'bam_smes_leg2_pds_on_gradflip_full_sample.svg', sep = ''), plot = plot_smes_pds, width = 5, height = 5, dpi = 300)
...
ggsave(paste(resdir_fig, 'bam_margtraj_leg2_SAexp_on_gradflip_full_sample.svg', sep = ''), plot = plot_margtraj_SAexp, width = 6, height = 5, dpi = 300)
...
ggsave(paste(resdir_fig, 'bam_margtraj_leg2_age_on_gradflip_full_sample.svg', sep = ''), plot = plot_margtraj_age, width = 6, height = 5, dpi = 300)
...
ggsave(paste(resdir_fig, 'bam_margtraj_leg2_pds_on_gradflip_full_sample.svg', sep = ''), plot = plot_margtraj_pds, width = 6, height = 5, dpi = 300)
