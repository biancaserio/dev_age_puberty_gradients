...
# Age and PDS on similarity to adult S-A axis (rcoef - continuous variabile - guassian) 
...
##### Main Model rcoef ~ Sex + s(PDS) + s(age) + tot_SA + random effect(site/family relatedness/subject)
# + BMIz
